...
class StatusQuestionable(Group, metaclass=InstrumentMetaclass):
...
class StatusAuxillary(Group, metaclass=InstrumentMetaclass):
    class ntransition(GenericGetSetCommandClass):
        """Program the negative transition filter"""
...
class StatusOperation(Group, metaclass=InstrumentMetaclass):
    class ntransition(GenericGetSetCommandClass):
        """Program the negative transition filter"""
...
class StatusMeasurement(Group, metaclass=InstrumentMetaclass):
    class ntransition(GenericGetSetCommandClass):
        """Program the negative transition filter"""
...
class Status(Group, metaclass=InstrumentMetaclass):
...
class ConfigureScalarCurrent(Group, metaclass=InstrumentMetaclass):
...
class ConfigureScalarVoltage(Group, metaclass=InstrumentMetaclass):
    class dc(GenericCommandClass):
...
class ConfigureScalar(Group, metaclass=InstrumentMetaclass):
...
class Configure(Group, metaclass=InstrumentMetaclass):
    scalar = ConfigureScalar


class Calibration(Group, metaclass=InstrumentMetaclass):
...
class MeasureScalarCurrent(Group, metaclass=InstrumentMetaclass):
    class dc(GenericCommandClass):
...
class MeasureScalarVoltage(Group, metaclass=InstrumentMetaclass):
    class dc(GenericCommandClass):
...
class MeasureScalar(Group, metaclass=InstrumentMetaclass):
...
class Measure(Group, metaclass=InstrumentMetaclass):
    scalar = MeasureScalar


class SystemError(Group, metaclass=InstrumentMetaclass):
...
class SystemSensor(Group, metaclass=InstrumentMetaclass):
...
class SystemBeeper(Group, metaclass=InstrumentMetaclass):
...
class System(Group, metaclass=InstrumentMetaclass):
    error = SystemError
    sensor = SystemSensor
    beeper = SystemBeeper
...
class Initiate(Group, metaclass=InstrumentMetaclass):
    class immediate(GenericCommandClass):
        """Start measurement"""
...
class SenseEnergyRange(Group, metaclass=InstrumentMetaclass):
...
class SenseEnergyReference(Group, metaclass=InstrumentMetaclass):
    class state(GenericGetSetCommandClass):
...
class SenseEnergy(Group, metaclass=InstrumentMetaclass):
...
class SensePowerDcReference(Group, metaclass=InstrumentMetaclass):
    class state(GenericGetSetCommandClass):
        """Switches to delta mode"""
...
class SensePowerDcRange(Group, metaclass=InstrumentMetaclass):
...
class SensePowerDc(Group, metaclass=InstrumentMetaclass):
...
class SensePower(Group, metaclass=InstrumentMetaclass):
    dc = SensePowerDc


class SenseAverage(Group, metaclass=InstrumentMetaclass):
...
class SenseCurrentDcRange(Group, metaclass=InstrumentMetaclass):
    class auto(GenericGetSetCommandClass):
        """Switches the auto-ranging function on and off"""
...
class SenseCurrentDcReference(Group, metaclass=InstrumentMetaclass):
    class state(GenericGetSetCommandClass):
        """Switches to delta mode"""
...
class SenseCurrentDc(Group, metaclass=InstrumentMetaclass):
...
class SenseCurrent(Group, metaclass=InstrumentMetaclass):
    dc = SenseCurrentDc


class SenseFrequencyRange(Group, metaclass=InstrumentMetaclass):
...
class SenseFrequency(Group, metaclass=InstrumentMetaclass):
    range = SenseFrequencyRange


class SenseVoltageDcRange(Group, metaclass=InstrumentMetaclass):
    class auto(GenericGetSetCommandClass):
        """Switches the auto-ranging function on and off"""
...
class SenseVoltageDc(Group, metaclass=InstrumentMetaclass):
...
class SenseVoltage(Group, metaclass=InstrumentMetaclass):
    dc = SenseVoltageDc


class SenseCorrectionPowerPdiode(Group, metaclass=InstrumentMetaclass):
...
class SenseCorrectionPower(Group, metaclass=InstrumentMetaclass):
    pdiode = SenseCorrectionPowerPdiode


class SenseCorrectionLossInput(Group, metaclass=InstrumentMetaclass):
...
class SenseCorrectionLoss(Group, metaclass=InstrumentMetaclass):
    input = SenseCorrectionLossInput


class SenseCorrectionEnergyPyro(Group, metaclass=InstrumentMetaclass):
    class maximum_response(GenericGetCommandClass):
...
class SenseCorrectionEnergy(Group, metaclass=InstrumentMetaclass):
    pyro = SenseCorrectionEnergyPyro


class SenseCorrectionCollectZero(Group, metaclass=InstrumentMetaclass):
...
class SenseCorrectionCollect(Group, metaclass=InstrumentMetaclass):
    zero = SenseCorrectionCollectZero


class SenseCorrection(Group, metaclass=InstrumentMetaclass):
...
class SensePeakdetector(Group, metaclass=InstrumentMetaclass):
...
class Sense(Group, metaclass=InstrumentMetaclass):
    energy = SenseEnergy
    power = SensePower
...
class InputAdapter(Group, metaclass=InstrumentMetaclass):
...
class InputThermopileAccelerator(Group, metaclass=InstrumentMetaclass):
...
class InputThermopile(Group, metaclass=InstrumentMetaclass):
    accelerator = InputThermopileAccelerator


class InputPdiodeFilterLpass(Group, metaclass=InstrumentMetaclass):
    class state(GenericGetSetCommandClass):
...
class InputPdiodeFilter(Group, metaclass=InstrumentMetaclass):
    lpass = InputPdiodeFilterLpass


class InputPdiode(Group, metaclass=InstrumentMetaclass):
    filter = InputPdiodeFilter


class Input(Group, metaclass=InstrumentMetaclass):
    adapter = InputAdapter
    thermopile = InputThermopile
    pdiode = InputPdiode


class Display(Group, metaclass=InstrumentMetaclass):
...
class ThorlabsPM100(Generic, InstrumentCommand, metaclass=InstrumentMetaclass):
    status = Status
    configure = Configure
